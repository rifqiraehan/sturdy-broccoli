...
--
-- Host: 127.0.0.1
-- Generation Time: May 07, 2024 at 12:13 PM
...
(1, 'admin@admin.com', '$2y$10$eSL5pAOw78C3aRjlRotuYOKEJwmWji4PtmLZ00JyW1kIc3dekn9zG', 1, 'Putri', 'Cahyani', '', '', '', 1, '', 'P25FngrHIvxofDZ', '2024-05-01'),
(13, 'putricahyani@gmail.com', '$2y$10$bGASiBHwtt58TQ51uCBTnONHVbrV.Bs5UOKlP4M8s8h9DuBle9hLq', 0, 'putri', 'cahya', '', '', '', 1, 'KeNIyAjBoqiw', 'cvkRHL1TfC7QbJ2', '2024-04-29'),
(14, 'shoru@gmail.com', '$2y$10$SRb.MiVRYyYZb9f6Zll0vu437mblYQHTsew/K.cZAe68uBfEG38CO', 0, 'husain', 'anshor', '', '', '', 1, '82l9pWKhitI4', '', '2024-05-07');
...
ALTER TABLE `sales`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`,`pay_id`);
...
--
ALTER TABLE `details`
  ADD CONSTRAINT `details_ibfk_1` FOREIGN KEY (`sales_id`) REFERENCES `sales` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `details_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
